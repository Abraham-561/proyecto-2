  ...
  return (
    <article className="weather">
      ...
      <section className='weather__body'>
        ...
        <article className='weather__condition'>
          ...
          <ul className='weather__list'>
            <li className=''><span className='weather__label'>Wind speed</span><span className='weather__value'>{weather?.wind.speed}m/s</span></li>
            <li className=''><span className='weather__label'>Clouds</span><span className='weather__value'>{weather?.clouds.all}%</span></li>
            <li className=''><span className='weather__label'>Pressure</span><span className='weather__value'>{weather?.pressure}hPa</span></li>
          </ul>
        </article>
      </section >
      ...
      <footer className='weather__footer'>
        <button className='weather__btn' onClick={changeTemperature}>Change To Fº/Cº</button>
      </footer>
    </article>
  )
}
